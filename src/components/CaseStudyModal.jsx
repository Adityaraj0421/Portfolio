...
export default function CaseStudyModal({ project, onClose }) {
    // Isolate scroll for the modal
    useEffect(() => {
        const lenis = new Lenis({
            wrapper: document.querySelector('.case-study-scroll'),
            content: document.querySelector('.case-study-content'),
            duration: 1.2,
    ...
    return (
        ...
        >
            ...
            <button
                onClick={onClose}
                className="absolute top-8 right-8 z-50 p-4 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white hover:bg-white hover:text-black transition-all group"
            >
                <X size={24} className="group-hover:rotate-90 transition-transform duration-300" />
            </button>

            {/* Scrollable Container */}
            <div className="case-study-scroll w-full h-full overflow-y-auto">
                <div className="case-study-content min-h-screen pb-24">
